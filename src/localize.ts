...
const en: Record<string, string> = {
  ...
  "card.today": "Today",
  "card.clear": "Clear",
  "card.clear_title": "Back to the defaults: everybody shown, today, and the configured map",
  "card.from": "From",
  "card.to": "To",
...
const de: Record<string, string> = {
  ...
  "card.today": "Heute",
  "card.clear": "Zurücksetzen",
  "card.clear_title": "Zurück zur Werkseinstellung: alle sichtbar, heutiger Tag, eingestellte Karte",
  "card.from": "Von",
  "card.to": "Bis",
